<template>
  <div class="shamba_table max-w-7xl mx-auto">
    <div class="mx-auto  pt-9 pb-2 px-4 sm:px-6 lg:px-8">
      <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
          <router-link to="/add_farm" type="button" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add user</router-link>
        </div>
      </div>
    </div>
    <div class="mt-2 flow-root overflow-hidden ring-1 ring-gray-300 sm:mx-0 sm:rounded-lg mb-3">
      <div class="mx-auto   px-4 sm:px-6 lg:px-8">
        <table class="w-full text-left">
          ...
          <tr>
            ...
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 md:table-cell">Crop(s)</th>
