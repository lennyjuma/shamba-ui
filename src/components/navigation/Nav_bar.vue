      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          ...
          <div class="hidden pl-5 sm:ml-6 sm:flex sm:space-x-8">
            ...
            <router-link to="/charts" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Charts</router-link>
            <router-link to="/tables" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Tables</router-link>
